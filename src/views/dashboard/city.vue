...
import { getSelecting, getIssue, getCount } from './api';
...
const { userPageData, issueData, selectingData, countData } = toRefs(state);
//查询系统公告
...
<template>
  <div class="main-content">
    <div class="headeImg">
      ...
      <a target="_blank" class="pdfUrl" href="/operationManual/安徽省工程造价咨询行业优秀企业和个人申报系统市级审核操作手册.pdf">
        <el-button type="warning" round class="handbook">市级认定操作手册</el-button>
      </a>
    </div>
            ...
            <div class="my-todoList">
              <div class="todoList">
                ...
                <div class="todoList-content">
                  <p>待办事项</p>
                  <router-link class="todo-number" :to="{ path: '/municipalReview/backlog' }">
                    {{ issueData.numsOfToDo }}
                  </router-link>
                </div>
              </div>
              <div class="doneList">
                ...
                <div class="todoList-content">
                  <p>已办事项</p>
                  <router-link class="done-number" :to="{ path: '/municipalReview/haveDone' }">
                    {{ issueData.numsOfDone }}
                  </router-link>
                </div>
              </div>
            </div>
        ...
        <el-col :span="14">
          <el-card class="item-card-bottom">
            ...
            <div class="selecting-body">
              <div class="selecting" v-for="item in selectingData" v-if="selectingData.length">
